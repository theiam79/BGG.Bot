...
namespace BGG.Bot.Modules
{
  public class HelpModule : ModuleBase<SocketCommandContext>
  {
    ...
    public HelpModule(HelperService helperService, InteractiveService interactiveService, IHost host)
    {
    ...
    public async Task Help()
    {
      ...
      await _helperService.HelpAsync(Context);
    }

    [Command("help")]
    [Summary("Shows information about a command")]
    public Task Help([Remainder] string command) => _helperService.HelpAsync(Context, command);
